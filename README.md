This Python script is engineered to manage and optimize network routing within a Mininet-simulated network landscape. By using RESTConf API and the ONOS controller,
